...
Route::group(["middleware" => "auth:api"], function (){
    Route::get('/me', 'Api\UsersController@me')->name('api.me')->middleware('can:view-developer-dashboard');
    Route::post('/change-password', 'Api\UsersController@changePassword')->name('api.change-password');
    Route::post('/update-user-details', 'Api\UsersController@updateUserDetails')->name('api.update-user-details');
});
